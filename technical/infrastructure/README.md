...
This directory contains all infrastructure, deployment, and operations documentation for saas202511.
...
- Add secrets to: `https://github.com/YOUR_ORG/saas202511/settings/secrets/actions`
...
|-------------|---------|-----|-------------|
| **Development** | Local machine | localhost:3011 | Manual |
| **Staging** | Testing/QA | saas202511-staging.azurecontainerapps.io | On push to `develop` |
| **Production** | Live users | saas202511.azurecontainerapps.io | On release tag |
