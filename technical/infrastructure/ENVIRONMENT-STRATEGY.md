...
| **URL** | localhost:3011 | staging.azurecontainerapps.io | azurecontainerapps.io |
...
DEBUG=true
DATABASE_URL=postgresql://localhost:5411/saas202511
...
NODE_ENV=staging
DEBUG=true
DATABASE_URL=postgresql://saas202511-db.postgres.database.azure.com/saas202511_staging
REDIS_URL=rediss://saas202511-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202511-staging.azurecontainerapps.io
CORS_ORIGINS=https://saas202511-staging.azurecontainerapps.io
```
...
NODE_ENV=production
DEBUG=false
DATABASE_URL=postgresql://saas202511-db.postgres.database.azure.com/saas202511_production
REDIS_URL=rediss://saas202511-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202511.azurecontainerapps.io
CORS_ORIGINS=https://saas202511.azurecontainerapps.io,https://yourdomain.com
```
...
STAGING_URL=https://saas202511-staging.azurecontainerapps.io npm run test:e2e
```
