...
1. Go to: `https://github.com/YOUR_ORG/saas202511/settings/secrets/actions`
...
# Check: https://github.com/YOUR_ORG/saas202511/actions
```

**Staging will be live at:** `https://saas202511-staging.azurecontainerapps.io`
...
**Production will be live at:** `https://saas202511.azurecontainerapps.io`

---

## Azure Resources Created

### Resource Group: `saas202511-rg`

All resources are organized in one resource group for easy management.

### Container Registry: `saas202511acr`

**Purpose:** Stores Docker images
**SKU:** Basic (upgradeable to Standard/Premium)
**URL:** `saas202511acr.azurecr.io`

### Container Apps Environment: `saas202511-env`
...
1. **saas202511-staging** (staging environment)
   - URL: `https://saas202511-staging.azurecontainerapps.io`
   - Min replicas: 1, Max replicas: 3
   - Auto-deploys on push to `develop` branch

2. **saas202511-prod** (production environment)
   - URL: `https://saas202511.azurecontainerapps.io`
   - Min replicas: 2, Max replicas: 10
   - Deploys on release tags only

### PostgreSQL Flexible Server: `saas202511-db`
...
**Databases:**
- `saas202511_staging` - Staging environment
- `saas202511_production` - Production environment

### Redis Cache: `saas202511-redis`
...
### Blob Storage: `saas202511storage`
...
az keyvault secret show \
  --vault-name saas202511-kv \
  --name DATABASE-URL-PRODUCTION \
  --query value -o tsv

# Connect with psql
psql "postgresql://username:password@saas202511-db.postgres.database.azure.com:5432/saas202511_production?sslmode=require"
```
...
2. Find your Container App: `saas202511-prod`
...
az containerapp logs show \
  --name saas202511-staging \
  --resource-group saas202511-rg \
  --follow

# Stream logs (production)
az containerapp logs show \
  --name saas202511-prod \
  --resource-group saas202511-rg \
  --follow
```
...
az monitor metrics alert create \
  ...
  --resource-group saas202511-rg \
  --scopes /subscriptions/{sub-id}/resourceGroups/saas202511-rg/providers/Microsoft.App/containerApps/saas202511-prod \
...
```
https://github.com/YOUR_ORG/saas202511/actions
```
...
az monitor metrics list \
  --resource /subscriptions/{sub-id}/resourceGroups/saas202511-rg/providers/Microsoft.App/containerApps/saas202511-prod \
...
az postgres flexible-server restore \
  --resource-group saas202511-rg \
  --name saas202511-db-restored \
  --source-server saas202511-db \
...
az containerapp revision activate \
  --name saas202511-prod \
  --resource-group saas202511-rg \
  --revision saas202511-prod--previous-revision
```
...
- **Project Repository**: https://github.com/ChrisStephens1971/saas202511
