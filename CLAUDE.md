...
**IMPORTANT: Before greeting, ALWAYS check project-brief/ folder first.**

**Step 0: Automatic Project Brief Check**

```bash
# Check if project-brief directory has any .md files
ls -la project-brief/*.md 2>/dev/null
```

**If project brief files exist:**
1. Read ALL `.md` files in `project-brief/` directory
...
3. Store this context for planning

**Then greet user:**

> "👋 Welcome to {{PROJECT_NAME}}! I've found your project brief in the project-brief/ folder and reviewed:
> - [List key files found]
>
> I understand you're building [brief summary from files]. Would you like help creating your roadmap and sprint plan based on this vision? Just say 'yes' or 'help me get started'!"

**If NO project brief files exist:**
...
- ✅ Specific container name (`saas202511-postgres`)
...
**Tell user:** "✅ Documentation saved and pushed to GitHub at https://github.com/ChrisStephens1971/saas202511"
